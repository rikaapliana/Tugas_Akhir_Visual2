...
if (edt1.Text='')or (edt2.Text='')  then
  ...
  zqry1.SQL.Add('insert into tbl_user values (null,"'+edt1.Text+'","'+edt2.Text+'","'+Cb1.Text+'","'+Cb2.Text+'")');
  zqry1.ExecSQL;
...
if (edt1.Text='')or (edt2.Text='')  then
  ...
  zqry1.SQL.Clear;
  zqry1.SQL.Add('Update tbl_user set username="'+edt1.Text+'",password="'+edt2.Text+'",level="'+Cb1.Text+'",status="'+Cb2.Text+'" where id_user="'+id+'"');
  zqry1.ExecSQL;
